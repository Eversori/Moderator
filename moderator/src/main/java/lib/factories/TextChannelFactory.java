...
public class TextChannelFactory
{
	...
	public static boolean addChannel(TextChannel channel)
	{
		return textChannelC.addTxtChannel(channel);
	}

	public static boolean removeChannel(TextChannel channel)
	{
		return textChannelC.removeTxtChannel(channel);
	}
}
